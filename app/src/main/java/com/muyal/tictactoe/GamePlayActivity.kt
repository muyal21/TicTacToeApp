...
class GamePlayActivity : AppCompatActivity() {
    ...
    private fun reset() {
        ...
        for (i in 1..9){
            ...
            player1TV.text = "player 2 : $player2count"
        }
    }
    ...
    private fun playNow(buttonSelected: Button, currCell: Int) {
        val audio = MediaPlayer.create(this,R.raw.mixkit_arcade_game)
        if (activeUser ==1){
    ...
    private fun checkWinner(): Int {
        val audio = MediaPlayer.create(this,R.raw.win_game)
        if ((player1.contains(1) && player1.contains(2) && player1.contains(3)) ||
            (player1.contains(1) && player1.contains(4) && player1.contains(7)) ||
            (player1.contains(3) && player1.contains(6) && player1.contains(9)) ||
            (player1.contains(8) && player1.contains(7) && player1.contains(9)) ||
            ...
            build.setMessage("Hurray Player 1 Wins \n\n"+"Do you want to play again")
            build.setPositiveButton("ok"){dilog,which->
                reset()
                audio.release()
            }
            ...
            (player2.contains(8) && player2.contains(7) && player2.contains(9)) ||
            ...
            val build = AlertDialog.Builder(this)
            build.setTitle("Game Over")
            build.setMessage("Hurray Player 2 Wins \n\n"+"Do you want to play again")
            build.setPositiveButton("ok"){dilog,which->
                reset()
                audio.release()
            }
